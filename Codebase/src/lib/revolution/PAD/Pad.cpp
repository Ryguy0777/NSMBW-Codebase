...
#define __cntlzw(_val) ({register u32 _rval; \
...
static OSShutdownFunctionInfo PAD_ResetFunctionInfo = {PAD_OnReset, 127};
...
int PAD_OnReset(int final, u32 event) {
  // PAL: 0x80386998
...
void PAD_SamplingHandler(s16 interrupt, OSContext* context) {
