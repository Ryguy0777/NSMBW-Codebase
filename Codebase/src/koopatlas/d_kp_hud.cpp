...
void dKPHud_c::loadHeaderInfo() {
    ...
    if ((conds & dMj2dGame_c::GOAL_MASK) && (infEntry->mFlag & dLevelInfo_c::FLAG_GOAL_MASK) == 0x30) {
        // If this level has two exits and one of them is already collected, show the faded flags
        normalState = 2;
        secretState = 2;
    }
