...
const SpriteData c_LIFT_BG_ROTATION_spritedata = {fProfile::AC_LIFT_BG_ROTATION, 8, -8, 0, 0, 0, 0, 0, 0, 0, 0, 2};
dCustomProfile_c l_LIFT_BG_ROTATION_profile(&g_profile_AC_LIFT_BG_ROTATION, "AC_LIFT_BG_ROTATION", SpriteId::AC_LIFT_BG_ROTATION, &c_LIFT_BG_ROTATION_spritedata);
