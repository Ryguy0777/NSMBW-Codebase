...
const SpriteData c_LARGE_KABOCHAN_spritedata = {fProfile::EN_LARGE_KABOCHAN, 8, -16, 0, 8, 8, 8, 0, 0, 0, 0, 0};
dCustomProfile_c l_LARGE_KABOCHAN_profile(&g_profile_EN_LARGE_KABOCHAN, "EN_LARGE_KABOCHAN", SpriteId::EN_LARGE_KABOCHAN, &c_LARGE_KABOCHAN_spritedata, l_LARGE_KABOCHAN_res);
