...
const SpriteData c_PATA_KURIBON_spritedata = {fProfile::EN_PATA_KURIBON, 8, -16, 0, 8, 8, 8, 0, 0, 0, 0, 0};
dCustomProfile_c l_PATA_KURIBON_profile(&g_profile_EN_PATA_KURIBON, "EN_PATA_KURIBON", SpriteId::EN_PATA_KURIBON, &c_PATA_KURIBON_spritedata, l_PATA_KURIBON_res);
