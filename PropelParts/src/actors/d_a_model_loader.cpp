#include <kamek.h>
#include <new/bases/d_a_model_loader.hpp>
...
dCustomProfile_c l_MODEL_LOADER_profile(&g_profile_AC_MODEL_LOADER, "AC_MODEL_LOADER", SpriteId::AC_MODEL_LOADER, &c_MODEL_LOADER_actor_data);
