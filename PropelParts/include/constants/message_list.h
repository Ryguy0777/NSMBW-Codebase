...
enum MESSAGE_e {
    ...
    MSG_MAIN_MENU_FAVORITES = 27,
    MSG_MAIN_MENU_RECOMMENDED_COURSES,
    MSG_MAIN_MENU_WORLD_X,

    // Group 0x66 [ BMG_CATEGORY_PRE_GAME ]
    MSG_PRE_GAME_WORLD = 31,
    MSG_PRE_GAME_DASH = 41,
